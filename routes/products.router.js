...
import { Product } from '../dao/models/Product.js'; // <-- ¡IMPORTA EL MODELO DE PRODUCTO AQUÍ!

const router = Router();

// Ruta POST para crear un nuevo producto
router.post('/', async (req, res) => { // <-- ¡ASYNC ES CLAVE AQUÍ!
    try {
        ...
        console.log('✅ Producto guardado en DB con ID:', savedProduct._id); // <-- ¡ESTO TE MUESTRA EL ID REAL EN LA TERMINAL!
